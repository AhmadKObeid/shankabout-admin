...
import OrdersListItem from 'src/view/orders/list/OrdersListItem';
          ...
          <TableHead>
            <TableRow>
              ...
              <TableCellCustom
                ...
                name={'quantity'}
                label={i18n(
                  'entities.cart.fields.quantity',
                )}
                align="right"
              />
              <TableCellCustom
                label={i18n(
                  'entities.cart.fields.customer',
                )}
              />
              <TableCellCustom
                label={i18n(
                  'entities.cart.fields.orders',
                )}
              />              
          ...
          <TableBody>
            ...
            {!loading &&
              rows.map((row) => (
                ...
                <TableCell>
                  <OrdersListItem value={row.orders} />
                </TableCell>                  
                  <TableCell>
                    <Box
                      display="flex"
